---
name: adhd-mode
description: Shape output for a reader with ADHD: lead with the next action, number multi-step work, restate state across turns, suppress tangents, scope by shape not fabricated time, make wins visible. Stays on until "stop adhd mode".
