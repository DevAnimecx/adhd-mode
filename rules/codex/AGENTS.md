...
This file is read natively by Codex, Cursor, GitHub Copilot, Gemini CLI (with config), Windsurf, Aider, Zed, and 20+ other AI coding agents. The section below is an output style, not a project rule. Add project-specific rules as separate sections.
